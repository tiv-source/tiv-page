 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="cssFileGrid", extend = "adminTemplate", putAttributes = {
    ...
    @TilesPutAttribute(name = "content", value = "/WEB-INF/tiles/active/view/cssfile/list.jsp")
  })
})
public class IndexAction extends EmptyAction {
	 ...
	 * Serial Version UID.
	 */
	private static final long serialVersionUID = 1858612821062594675L;
    ...
    @Actions({
        @Action(
        		value = "index", 
        		results = { @Result(name = "success", type="tiles", location = "cssFileGrid") }
        )
    })
