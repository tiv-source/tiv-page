...
public class ImageEditAction extends EmptyAction implements UploadedFilesAware {
    ...
    public String execute() throws Exception {
    	...
    	if(pdf != null) {
    		...
    		dbPdf.getImage().setUploadFile(pdf.getImage().getUploadFile());
    		dbPdf.getImage().generate();
    		dbPdf.getImage().setModified(new Date());
    		dbPdf.getImage().setModifiedAddress(remoteAddress);
    		dbPdf.getImage().setModifiedBy(remoteUser);
    ...
    public void withUploadedFiles(List<UploadedFile> uploadedFiles) {
        ...
        if (!uploadedFiles.isEmpty()) {
            ...
            this.pdf.getImage().setUploadFile(UploadedFileToUploadFile.convert(uploadedFile));
         }
    }
