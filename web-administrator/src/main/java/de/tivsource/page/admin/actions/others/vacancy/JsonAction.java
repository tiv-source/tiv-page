...
public class JsonAction extends ActionSupport {
    ...
    @Actions({
        @Action(
        		value = "table", 
        		results = {
        		        @Result(name = "success", type="json", params={"excludeProperties", "gridModel.*.events, gridModel.*.vacancies, gridModel.*.applications, gridModel.*.picture, gridModel.*.pictureItems"})
        		}
        )
    })
