...
public class JsonAction extends ActionSupport {
    ...
    @Action(
            value = "table",
            results = {
                @Result(name = "success", type="json", params={"excludeProperties", "gridModel.*.pictures, gridModel.*.picture, gridModel.*.pictureItems, gridModel.*.groups, gridModel.*.pictureUrls"})
            }
        )
