 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="userGrid", extend = "adminTemplate", putAttributes = {
    ...
    @TilesPutAttribute(name = "content", value = "/WEB-INF/tiles/active/view/user/list.jsp")
  })
})
public class IndexAction extends EmptyAction {
    ...
    @Actions({
        @Action(
        		value = "index", 
        		results = { @Result(name = "success", type="tiles", location = "userGrid") }
        )
    })
