 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="locationGrid", extend = "adminTemplate", putAttributes = {
    ...
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/location/list.jsp")
  })
})
public class IndexAction extends EmptyAction {
    ...
    @Actions({
        @Action(
        		value = "index", 
        		results = { @Result(name = "success", type="tiles", location = "locationGrid") }
        )
    })
