...
public class BackupEvent {
    ...
    public static File getBackupFile() throws IOException {
    	...
    	// Format Definition 
    	backupFileWriterOut.write("[Format Definition] => uuid|uuid(de)|name(de)|description(de)|keywords(de)|uuid(en)|name(en)|description(en)|keywords(en)|visible|created|modified|modifiedBy|ip|price|beginning|ending|deadline|location|reservation|");
