 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="css",  extend = "adminTemplate", putAttributes = {
    ...
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/css/list.jsp")
  })
})
public class IndexAction extends EmptyAction {
	 ...
	 * Serial Version UID.
	 */
	private static final long serialVersionUID = 7127014826943686995L;
    ...
    @Actions({
        @Action(
        		value = "index", 
        		results = { @Result(name = "success", type="tiles", location = "css") }
        )
    })
