...
<struts:url var="pdfUrl" namespace="/others/pdf" action="pdfForm">
  <struts:param name="uncheckPdf" value="pdf.uuid" />
      ...
      <div class="main">
        ...
        <div id="title">
          <h5><struts:text name="pdf.edit"/></h5>
        </div>
          ...
          >
            ...
            <fieldset class="fieldset">
              ...
              <div class="field">
                ...
                $('#edit_pdf_dateOfPublication').datetimepicker({ 
                	datepicker: true,
                	timepicker: false,
                    format: 'd.m.Y',
                	lang: 'de',
            ...
            <struts:if test="lang=='EN'">
              ...
              <div class="field">
                <struts:textfield 
                    key="pdf.descriptionMap.EN.name"
                    parentTheme="css_xhtml"
                    cssStyle="padding: 0.3em; width:827px;"
                />
              </div>
              ...
              <div class="field">
                <struts:textarea 
                    key="pdf.descriptionMap.EN.description" 
                    cols="115" 
                    rows="8" 
                    parentTheme="css_xhtml"
                ></struts:textarea>	  
              ...
              <div class="field">
                <struts:textfield 
                    key="pdf.descriptionMap.EN.keywords"  
                    parentTheme="css_xhtml"
                    cssStyle="padding: 0.3em; width:827px;"
                />
              </div>
