...
<struts:url var="englishUrl">
  <struts:param name="uncheckFeedbackOption" value="feedbackOption.uuid" />
...
<struts:url var="germanUrl">
  ...
  <struts:param name="lang">DE</struts:param>
      ...
      <div class="main">
        ...
        <div id="title">
          <h5><struts:text name="feedbackOption.edit"/></h5>
        </div>
          ...
          >
            ...
            <fieldset class="fieldset">
              ...
              <div class="field">
                ...
                />
                <script type="text/javascript">
                $('#add_feedbackOption_orderNumber').spinner();
                </script>
              </div>
            ...
            <struts:if test="lang=='EN'">
              ...
              <div class="field">
                <struts:textfield 
                    key="feedbackOption.descriptionMap.EN.name"
                    parentTheme="xhtml"
                    cssStyle="padding: 0.3em; width:827px;"
                />
              </div>
              ...
              <div class="field">
                <struts:textarea 
                    key="feedbackOption.descriptionMap.EN.description" 
                    cols="115" 
                    rows="8" 
                    parentTheme="xhtml"
                ></struts:textarea>	  
              ...
              <div class="field">
                <struts:textfield 
                    key="feedbackOption.descriptionMap.EN.keywords"  
                    parentTheme="xhtml"
                    cssStyle="padding: 0.3em; width:827px;"
                />
              </div>
              ...
              <div class="field">
                <struts:textfield 
                    key="feedbackOption.descriptionMap.EN.hints"
                    parentTheme="css_xhtml"
                    cssStyle="padding: 0.3em; width:827px;"
                />
              </div>
