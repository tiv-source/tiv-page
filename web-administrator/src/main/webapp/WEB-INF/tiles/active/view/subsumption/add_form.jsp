...
<%@ taglib prefix="struts" uri="/struts-tags" %>
      ...
      <div class="main">
        ...
        <div id="title">
          <h5><struts:text name="subsumption.add"/></h5>
        </div>
        ...
        <div id="backend_update_form" class="update">
          ...
          >
            ...
            <fieldset class="fieldset">
              ...
              <struts:hidden key="subsumption.descriptionMap.EN.name" value="No English content available."/>
              <struts:hidden key="subsumption.descriptionMap.EN.description" value="No English content available."/>
              <struts:hidden key="subsumption.descriptionMap.EN.keywords" value="No English content available."/>
              <struts:hidden key="subsumption.contentMap.EN.content" value="No English content available."/>
