...
function formatLinks(cellvalue, options, rowObject) {
  return "<a href='/admin/others/manual/editForm.html?uncheckManual="+ cellvalue + "' style='border-style: none; display: inline;'>" + 
         "<img src='/admin/icons/16x16/pencil.png' style='width:14px;'/>" + 
         "</a>&nbsp;&nbsp;&nbsp;" + 
         "<a href='/admin/others/manual/deleteForm.html?uncheckManual="+ cellvalue +"' style='border-style: none; display: inline;'>" + 
