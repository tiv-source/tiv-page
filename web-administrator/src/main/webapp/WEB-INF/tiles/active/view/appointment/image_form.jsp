        ...
        <div id="backend_update_form" class="update">
          ...
          >
            ...
            <fieldset class="fieldset">
              ...
              <div class="field">
                <label for="appointment.descriptionMap.DE.name" class="label">Name:</label>
                <struts:hidden id="appointment.descriptionMap.DE.name" key="appointment.descriptionMap.DE.name"/>
