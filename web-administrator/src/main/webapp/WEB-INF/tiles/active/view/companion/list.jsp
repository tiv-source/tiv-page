...
<struts:url var="companionAddUrl" action="addForm" namespace="/others/companion" />
<struts:url var="remoteurl" action="table" namespace="/others/companion"/>

<script type="text/javascript">
function formatLinks(cellvalue, options, rowObject) {
  return "<a href='/admin/others/companion/editForm.html?uncheckCompanion="+ cellvalue + "' style='border-style: none; display: inline;'>" + 
         "<img src='/admin/icons/16x16/pencil.png' style='width:14px;'/>" + 
         "</a>&nbsp;&nbsp;&nbsp;" + 
         "<a href='/admin/others/companion/deleteForm.html?uncheckCompanion="+ cellvalue +"' style='border-style: none; display: inline;'>" + 
...
function formatIsoDate(celldate, options, rowObject) {
    ...
    return newDate.toLocaleTimeString('de-DE', timeOptions) + " - " + newDate.toLocaleDateString('de-DE', dateOptions);
      ...
      <div class="main">
        <div class="sub_menu">
          <struts:a href="%{companionAddUrl}">
            <struts:text name="companion.add"/>
          </struts:a>
        </div>
...
$(function () {
    $("#entityList").jqGrid({
        url: "/admin/others/companion/table.html",
        datatype: "json",
        mtype: "GET",
        colNames: [
            '<struts:text name="companion.name"/>',
            '<struts:text name="companion.appendix"/>',
            '<struts:text name="companion.contactDetails.telephone"/>',
            '<struts:text name="companion.contactDetails.fax"/>',
        ...
        colModel: [
            ...
            { name: "appendix",                          width:   70, align: "left" },
            { name: "contactDetails.telephone",          width:   70, align: "left", index:"telephone" },
            { name: "contactDetails.fax",                width:   70, align: "left", index:"fax" },
            { name: "visible",                           width:   70, align: "right", formatter:formatTrueFalse },
            { name: "created",                           width:  100, align: "center", formatter:formatIsoDate },
            { name: "modified",                          width:  100, align: "center", formatter:formatIsoDate },
        ...
        cellLayout : 5,
        height:'auto',
        caption: '<struts:text name="companions"/>'
    }); 
}); 
</script>
