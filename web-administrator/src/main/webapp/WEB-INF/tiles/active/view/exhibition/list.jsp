...
$(function () {
    $("#entityList").jqGrid({
        ...
        colNames: [
            ...
            '<struts:text name="exhibition.visibleFrom"/>',
        ...
        colModel: [
            ...
            { name: "descriptionMap.DE.name",  width:  235, align: "left", index: "name" },
            ...
            { name: "visibleFrom",             width:  105, align: "right", formatter:formatIsoDateTime },
            { name: "visible",                 width:  110, align: "right", formatter:formatTrueFalse },
            { name: "created",                 width:  110, align: "center", formatter:formatIsoDate },
            { name: "modified",                width:  110, align: "center", formatter:formatIsoDate },
