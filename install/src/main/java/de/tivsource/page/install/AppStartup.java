...
public class AppStartup implements ServletContextListener {
    ...
    private void checkAllAttributesExisting() {
        String[][] properties = {
                ...
                {"exhibition.list.moment.nice",                           "true"},
                {"exhibition.list.description",                           "true"},
                {"exhibition.list.start",                                 "true"},
                {"exhibition.list.end",                                   "true"},
                {"captcha.image.lastModified",                            "Sun, 24 Nov 2019 14:26:08 GMT"},
                {"pdf.lastModified",                                      "Sun, 24 Nov 2019 14:26:08 GMT"},
                {"pdf.image.lastModified",                                "Sun, 24 Nov 2019 14:26:08 GMT"},
                ...
                {"pictureItem.image.lastModified",                        "Sun, 24 Nov 2019 14:26:08 GMT"},
                ...
                {"module.pdf",                                            "false"},
                {"module.press",                                          "false"},
                {"module.exhibition",                                     "false"},
                {"news.on.home",                                          "false"},
                {"news.on.home.quantity",                                 "2"},
                {"request.template.path",                                 "file:/srv/tiv-page/templates/template_request.xml"},
                {"socialmedia.mastodon.url",                              ""},
                {"socialmedia.mastodon.url.icon",                         ""},
                {"socialmedia.mastodon.url.icon.alt",                     "Mastodon"},
                {"socialmedia.whatsapp.url",                              ""},
                {"socialmedia.whatsapp.url.icon",                         "/uploads/WhatsApp.png"},
                {"socialmedia.whatsapp.url.icon.alt",                     "WhatsApp"},
                {"pdf.list.show.edition",                                 "true"},
                {"pdf.list.show.edition.description",                     "true"},
                {"pdf.list.show.created",                                 "true"},
                {"pdf.list.show.created.nice",                            "true"},
                {"pdf.list.show.created.description",                     "true"},
                {"pdf.list.show.created.description.nice",                "true"},
                {"pdf.list.show.dateOfPublication",                       "true"},
                {"pdf.list.show.dateOfPublication.nice",                  "true"},
                {"pdf.list.show.dateOfPublication.description",           "true"},
                {"pdf.list.show.dateOfPublication.description.nice",      "true"},
                {"pdf.list.show.downloadCounter",                         "true"},
                {"pdf.list.show.downloadCounter.description",             "true"},
                ...
                {"og.image.exhibition",                                   "normal.png"},
                {"exhibition.list.image",                                 "normal.png"},
                {"exhibition.view.image",                                 "large.png"},
        };
