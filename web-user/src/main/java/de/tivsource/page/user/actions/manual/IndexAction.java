 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="manualList", extend = "userTemplate", putAttributes = {
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/manual/manual_list.jsp")
  })
})
