...
@TilesDefinitions({
  @TilesDefinition(name="appointment", extend = "userTemplate", putAttributes = {
    ...
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/appointmentarchive/appointment.jsp")
  })
})
public class AppointmentAction extends EmptyAction {
     ...
     * Serial Version UID.
     */
    private static final long serialVersionUID = 2449929224384587137L;
    ...
    public String execute() throws Exception {
        ...
        appointmentUuid = appointmentUuid.replaceAll("/appointmentarchive/", "");
