package de.tivsource.page.user.actions.press;
 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="pressList", extend = "userTemplate", putAttributes = {
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/pdf/press_list.jsp")
  })
})
public class IndexAction extends EmptyAction implements Pagination {
     ...
     * Serial Version UID.
     */
    private static final long serialVersionUID = 5468371990838987891L;
    ...
    public void prepare() {
        ...
        page = pageDaoLocal.findByTechnical("press");
    }

    @Override
    @Actions({
        @Action(value = "index", results = {
            @Result(name = "success", type = "tiles", location = "pressList"),
    ...
    public String execute() throws Exception {
        ...
        boolean moduleEnabled = propertyDaoLocal.findByKey("module.press").getValue().equals("true") ? true : false;
        ...
        if(moduleEnabled) {
            ...
            pdfs = pdfDaoLocal.findAllVisible(from, TO);
            return SUCCESS;
        } else {
    ...
    private void getDBCount() {
        ...
        dbQuantity = pdfDaoLocal.countAllVisible();
