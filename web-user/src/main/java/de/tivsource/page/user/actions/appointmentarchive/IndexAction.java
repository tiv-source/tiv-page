package de.tivsource.page.user.actions.appointmentarchive;
 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="appointmentList", extend = "userTemplate", putAttributes = {
    @TilesPutAttribute(name = "content",    value = "/WEB-INF/tiles/active/view/appointmentarchive/appointment_list.jsp")
  })
})
public class IndexAction extends EmptyAction implements Pagination {
     ...
     * Serial Version UID.
     */
    private static final long serialVersionUID = 7058902491176190455L;
    ...
    public String execute() throws Exception {
        ...
        appointments = appointmentDaoLocal.findAllArchiveVisible(from, TO);
        return SUCCESS;
    ...
    private void getDBCount() {
        ...
        dbQuantity = appointmentDaoLocal.countAllArchiveVisible();
