 ...
 */
@TilesDefinitions({
  @TilesDefinition(name="picture", extend = "userTemplate", putAttributes = {
    @TilesPutAttribute(name = "meta",    value = "/WEB-INF/tiles/active/meta/picture.jsp"),
    @TilesPutAttribute(name = "content", value = "/WEB-INF/tiles/active/view/gallery/picture.jsp")
  })
})
