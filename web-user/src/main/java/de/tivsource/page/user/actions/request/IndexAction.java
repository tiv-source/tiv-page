...
public class IndexAction extends EmptyAction {
     ...
     * Serial Version UID.
     */
    private static final long serialVersionUID = 1509866834596943504L;
    ...
    @Actions({
        @Action(
        		value = "index", 
        		results = {
        		  @Result(name = "success", type="tiles", location = "request"),
    ...
    public String execute() throws Exception {
    	...
    	boolean moduleEnabled = propertyDaoLocal.findByKey("module.request").getValue().equals("true") ? true : false;
