...
<%@ taglib prefix="struts" uri="/struts-tags"%>
  ...
  <title><struts:property value="location.getName(getText('language'))" /> <struts:text name="page" /> <struts:property value="current" /></title>
  <meta name="title" content="<struts:property value="location.getName(getText('language'))" /> <struts:text name="page" /> <struts:property value="current" />" />
  <meta name="searchtitle" content="<struts:property value="location.getName(getText('language'))" /> <struts:text name="page" /> <struts:property value="current" />" />
  ...
  <meta property="og:image" content="<struts:property value="getProperty('server.picture.url')" /><struts:property value="getProperty('og.image.size.location')" /><struts:property value="location.picture.pictureUrls.LARGE.url" />" />
