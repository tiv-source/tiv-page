...
<%@ taglib prefix="struts" uri="/struts-tags"%>
  ...
  <meta property="og:image" content="<struts:property value="getProperty('server.base.url')" />/image/pictureitem/<struts:property value="%{location.uuid}"/>/<struts:property value="getProperty('og.image.size.reservation.location')" />" />
